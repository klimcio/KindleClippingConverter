...
namespace KindleClippingTools.Tests
{
    public class TestingParsingClippingFileTests
    {
        ...
        public void Testing_when_one_clipping_file_will_return_list_of_one_element()
        {
            ...
            clipping.Content.Should().StartWith("„Tora”, czyli „Prawo”, wskazuje na ich treść: przepisy prawa, przekazanego Mojżeszowi (stąd także nazwa „Prawo Mojżeszowe”) dla całego Izraela, zajmują najwięcej miejsca.");
        }
        ...
        public void Testing_multiple_clipping_file_will_return_list_of_elements()
        {
            ...
            bookmark.Title.Should().StartWith("Pismo Święte Starego Testamentu (Autor zbiorowy)",
                because: "When you use Equals you will learn that there's unexpected whitespace at the end.");
            ...
            note.Title.Should().StartWith("﻿Książę (Niccolo Machiavelli)");
            ...
            highlight1.Content.Should().StartWith("Nie będę wdawał się w rozprawę o republikach, gdyż gdzie indziej omówiłem je obszernie.");

            var highlight2 = highlights.ElementAt(1);
            highlight2.Title.Should().StartWith("﻿Książę (Niccolo Machiavelli)");
